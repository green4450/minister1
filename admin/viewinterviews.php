...
<div class="m-4">
    <?php
        include '../src/dbh.php';
        $sql = "SELECT * FROM interview ORDER BY id DESC;";
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            <div class="card mt-2">
                <div class="card-body">
                    ...
                    <h6 class="card-subtitle mb-2 text-muted">'.$row['youtube'].'</h6>
                    <p class="card-text">
                        '.$row['description'].'
                    </p>
                    <form method="POST">
        ...
        if (isset($_POST['delBtn'])) {
            ...
            echo '<script>window.location="./interview.php?delete=success"</script>';
        }
