    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <form action="../src/main.php" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            <label for="exampleInputEmail1">पुस्तकें का शीर्षक</label>
                ...
                <div class="form-group">
                    <label for="exampleInputPassword1">पुस्तकें का चित्र</label>
                ...
                <div class="form-group">
                    <label for="exampleInputPassword1">विवरण</label>
