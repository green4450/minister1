        ...
        <div class="col-md-6">
            ...
            <script>
                function myFunction() {
                    ...
                    if (x === 'English') {
                        window.location.href = "enews.php";
                    } else if (x === 'Hindi') {
            ...
            <form action="../src/main.php" method="POST" enctype="multipart/form-data">
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            <label for="exampleInputEmail1">समाचार का शीर्षक</label>
                ...
                <div class="form-group">
                    <label for="exampleInputPassword1">समाचार का विवरण</label>
                    <textarea class="form-control" id="description" name="description" rows="3"></textarea>
                </div>
                <button type="submit" name="newsSubmitBtn" class="btn btn-primary">Submit</button>
            </form>
        </div>
        <div class="col">
            <a href="./viewnews.php" class="btn btn-outline-info btn-lg">
                View All News
            </a>
        </div>
